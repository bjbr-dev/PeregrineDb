    ...
    internal class TypeMapper
    {
            ...
            bool removeUnused)
        {
            ...
            foreach (var prop in props)
            {
                ...
                if (dbType == Mapping.DynamicParameters.EnumerableMultiParameter)
                {
                    ...
                    il.EmitCall(OpCodes.Call, typeof(TypeMapper).GetMethod(nameof(PackListParameters)), null); // stack is [parameters]
                    continue;
                }
                ...
                if (checkForDuplicates)
                {
                    ...
                    il.EmitCall(OpCodes.Call, typeof(TypeMapper).GetMethod(nameof(FindOrAddParameter)), null); // stack is [parameters] [parameter]
                }
                else
                {
            ...
            bool returnNullIfFirstMissing = false)
        {
            ...
            il.EmitCall(OpCodes.Call, typeof(TypeMapper).GetMethod(nameof(ThrowDataException)), null);
