...
namespace PeregrineDb.Schema
{
    ...
    public class ColumnUsage
    {
        ...
        /// <summary>
        /// Gets a <see cref="ColumnUsage"/> for a column with a value which is generated by the databaseConnection when a row is created, e.g. a created timestamp.
        ...
        /// <summary>
        /// Gets a <see cref="ColumnUsage"/> for a column with a value which is computed by the databaseConnection when a row is created or updated, e.g. a last update timestamp.
        ...
        /// <summary>
        /// Gets a <see cref="ColumnUsage"/> for a primary key with a value which is generated by the databaseConnection.
