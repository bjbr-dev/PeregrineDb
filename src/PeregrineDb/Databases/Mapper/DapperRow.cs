namespace PeregrineDb.Databases.Mapper
{
    ...
    internal sealed class DapperRow
        : IDynamicMetaObjectProvider, IDictionary<string, object>
    {
        ...
        {
            get { return this.values.Count(value => !(value is DeadValue)); }
        }
        ...
        {
            var sb = StringBuilderPool.Acquire().Append("{DapperRow");
