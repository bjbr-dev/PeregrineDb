namespace PeregrineDb.Tests.Databases.Mapper
{
    ...
    public class ProcedureTests
    {
        ...
        ////    this.connection.Execute("#TestProcWithOutParameter", args, commandType: CommandType.StoredProcedure);
        ...
        ////    this.connection.Execute("#TestProcWithOutAndReturnParameter", args, commandType: CommandType.StoredProcedure);
        ////    Assert.Equal(7, args.Get<int>("ID"));
        ...
        ////    END");
        ////    var result = this.connection.Query(sql: "#up_MessageProcessed_get", param: p, commandType: CommandType.StoredProcedure);
        ...
        ////    var result = this.connection.Query<PracticeRebateOrders>("#GetPracticeRebateOrderByInvoiceNumber", new
        ////    {
        ...
        ////    {
        ////        get { return this.fTaxInvoiceNumber; }
        ////        set { this.fTaxInvoiceNumber = value; }
        ////    }
        ////}
        ...
        ////    var query = this.connection.QueryMultiple("#TestEmptyResults", commandType: CommandType.StoredProcedure);
        ...
        ////    begin
	       ...
	       ////     return @a
        ////    end");
        ////    Assert.Equal(1111, this.connection.Query<int>("#TestProc", p, commandType: CommandType.StoredProcedure).First());
        ...
        ////{
        ////    var results = this.connection.Query<string>("select * from (select 'a' str union select 'b' union select 'c') X where str in @strings",
        ////        new
        ////        {
        ////            strings = new[] {
        ...
        ////{
        ////    const string tempSPName = "#" + nameof(this.TestDateTime2PrecisionPreservedInDynamicParameters);
        ...
        ////    DateTime fromSelect = this.connection.Query<DateTime>(tempSPName, p, commandType: CommandType.StoredProcedure).First();
        ...
        ////{
        ////    const string tempSPName = "#" + nameof(this.TestDateTime2LosePrecisionInDynamicParameters);
