namespace PeregrineDb.PerformanceTests
{
    ...
    public class HandCodedGetBenchmarks : GetBenchmarks
    {
        ...
        public void Setup()
        {
            ...
            this._idParam = this._postCommand.Parameters.Add("@Id", SqlDbType.Int);
#if !NETCOREAPP1_0
        ...
        {
            this.Step();
            this._idParam.Value = this.i;

            using (var reader = this._postCommand.ExecuteReader())
            {
                reader.Read();
                var post = new Post();
        ...
        public dynamic DataTableDynamic()
        {
            ...
            using (var reader = this._postCommand.ExecuteReader())
            {
                ...
                this._table.Rows.Add(values);
                return this._table.Rows[this._table.Rows.Count - 1];
            }
        }
    }
}
